...
class Cube extends Component {
  ...
  getCorner = (colors) => {
    return (
      [
        <Tile key={'_'+colors[3]+0} k={'corner '+colors[3]+', tile '+0} color={colors[0]}/>,
        <Tile key={'_'+colors[3]+1} k={'corner '+colors[3]+', tile '+1} color={colors[1]}/>,
        <Tile key={'_'+colors[3]+2} k={'corner '+colors[3]+', tile '+2} color={colors[2]}/>,
      ]
    );
  }
